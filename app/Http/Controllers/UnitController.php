...
class UnitController extends Controller {
    ...
    public function index(Discipline $discipline) { return view('units.index', ['discipline' => $discipline, 'units' => $discipline->units]); }
    public function create(Discipline $discipline) { return view('units.create', ['discipline' => $discipline]); }
